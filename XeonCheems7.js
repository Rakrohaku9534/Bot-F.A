...
//Fake
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6281575769352-1627865417@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
...
*Link* : https://www.youtube.com/@fahrul2951`},
{quoted: m})
        break
        case 'oke':
case 'okey':
...
break
case "sendbug": {
if (!XeonTheCreator) return XeonBotInc.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/owner.webp'), m, { packname: 'F.A Botz', author: 'sabar ya\njangan lupa bantu follow\nyt: @fahrul2951\nig: fahrul_mt' }, { quoted: m})
...
XeonBotInc.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/wait.webp'), m, { packname: 'F.A Botz', author: 'sabar ya\njangan lupa bantu follow\nyt: @fahrul2951\nig: fahrul_mt' }, { quoted: m})
await sleep(1000)
...
𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲 𝗬𝗧 :
_https://www.youtube.com/@fahrul2951_
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
`
...
case 'ffstalk':{
if (!isPrem) return replyprem(mess.premium)
if (!q) return replygcxeon(`Example ${prefix+command} 6285786539008`)
replygcxeon(mess.wait)
...
case 'addprem':
if (!XeonTheCreator) return replygcxeon(mess.owner)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 6285786539008`)
...
let e = String(err)
XeonBotInc.sendMessage("6285786539008@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
